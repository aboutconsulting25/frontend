    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        <AnalysisSummaryCard
          ...
          variant="muted"
          items={[
            '국어 과목 1등급으로 강점 확인하였으며 유지하길 바람.',
            '사회 과목 2등급으로 강점 확인했으나 앞으로 1등급으로 상승하길 바람.',
            '이과임에도 불구하고 수학 4등급으로 다음학기 3등급대 진입 필수',
          ]}
        />
        <AnalysisSummaryCard
          title="약점 요약"
      ...
      <div className="space-y-4">
        ...
        <DiagnosisCard summary="수학과목의 성취도 향상과 정보 및 코딩 기반의 세특 보완을 통해 학생부종합전형 지원 전략을 추천합니다.">
          <div className="space-y-4">
            <p>
      ...
      <div className="space-y-4">
        ...
        <DiagnosisCard summary="수학 역량 강화 방안이 필요합니다.">
          <p>
        ...
        <DiagnosisCard summary="정보, 코딩 실력을 심화시키는 프로젝트를 추천합니다.">
          <p>
          ...
          <div className="grid grid-cols-3 gap-4 mt-4">
            <RecommendCard
              title="학교 급식 만족도 조사 데이터 분석"
              description="반 또는 학년 대상 급식 만족도 설문조사를 진행하고 해당 데이터를 Python의 Pandas 라이브러리를 이용하여 분석하고 시각화합니다. 평균, 최댓값, 그래프를 만들어보고 의미있는 인사이트를 도출해 내며 데이터 사이언스의 기초를 경험합니다."
            />
            <RecommendCard
              title="학교폭력 감지 대시보드 텍스트 데이터 분석"
              description="반 또는 학년 대상 급식 만족도 설문조사를 진행하고 해당 데이터를 Python의 Pandas 라이브러리를 이용하여 분석하고 시각화합니다. 평균, 최댓값, 그래프를 만들어보고 의미있는 인사이트를 도출해 내며 데이터 사이언스의 기초를 경험합니다."
            />
            <RecommendCard
              title="교내 에너지 낭비 감지 시스템 취리 모델 기반 예측"
              description="반 또는 학년 대상 급식 만족도 설문조사를 진행하고 해당 데이터를 Python의 Pandas 라이브러리를 이용하여 분석하고 시각화합니다. 평균, 최댓값, 그래프를 만들어보고 의미있는 인사이트를 도출해 내며 데이터 사이언스의 기초를 경험합니다."
            />
          </div>
        </DiagnosisCard>
      ...
      <div className="space-y-4">
        ...
        <DiagnosisCard summary="컴퓨터소프트웨어학과 도서를 추천합니다.">
          <div className="grid grid-cols-3 gap-4">
            <RecommendCard
              title="'코드: 하드웨어와 소프트웨어의 언어'(찰스 펫졸드)"
              description="해당 도서는 컴퓨터가 어떻게 0과 1이라는 단순한 신호로 정보를 처리하는지, 근본적으로 어떻게 전기 신호만으로 복잡한 작업을 할 수 있는지 등 전공 기초와 관련해 탐구할 수 있는 내용이 실려 있습니다. 또한 전공 이해도와 전공에 대한 흥미를 나타내는 데 좋은 책입니다."
            />
            <RecommendCard
              title="'메타버스'(김상균)"
              description="기술의 발전이 사람에게 어떤 영향을 미치는지를 고민해 볼 수 있는 책입니다."
            />
            <RecommendCard
              title="'슈퍼 인텔리전스'(닉 보스트롬)"
              description="미래 사회에 필요한 역량과 태도를 나타내는 데 도움이 되는 책입니다."
            />
          </div>
        </DiagnosisCard>
      </div>
